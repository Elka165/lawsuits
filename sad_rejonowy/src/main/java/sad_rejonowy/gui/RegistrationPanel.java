package sad_rejonowy.gui;

import sad_rejonowy.method.ListOfElements;
import sad_rejonowy.method.PropertiesLoader;
...
public class RegistrationPanel {
    ...
    JLabel txtPermissions;
    JComboBox permissionCombo;
    ...
    public void addAllToRegistrationPanel(){
        ...
        addComponentToRegistrationPanel(txtMail);
        addComponentToRegistrationPanel(mailField);
        addComponentToRegistrationPanel(txtPermissions);
        addComponentToRegistrationPanel(permissionCombo);
    ...
    public void addMail() {
        txtMail = new JLabel("Adres e-mail");
        sizerAndColorSwing.assignSizeColorJLabel(txtMail, SIZE_X, 220);

        mailField = new JTextField(15);
        sizerAndColorSwing.assignSizeJTextField(mailField, SIZE_X, 250, WIDTH_FIELD);
    }

    public void addTypePermissions() {
        txtPermissions = new JLabel("Rodzaj uprawnień");
        sizerAndColorSwing.assignSizeColorJLabel(txtPermissions, SIZE_X, 280);

        permissionCombo = new JComboBox();
        sizerAndColorSwing.assignSizeJComboBox(permissionCombo, SIZE_X, 310, WIDTH_FIELD, listOfElements.getListOfPermissions());
    }
    ...
    public void addBackToLoginPanel(){
        ...
        sizerAndColorSwing.changeFontWhenMoveMouseAndActivateNemFrame(txtBackToLoginPanel, registrationFrame, "sad_rejonowy.gui.Login");
    }
}
